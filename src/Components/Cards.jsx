...
const Cards = ({ resident }) => {
    ...
    return (
        <>
            {/* HTML Y CSS de cada Card */}
            <div>
                <img src={image} alt={image} onClick={handleModal} className='cursor-pointer  w-full  md:h-auto transition-all hover:scale-105 '/>
                ...
                <div className='fixed inset-0 bg-black bg-opacity-20 backdrop-blur-sm flex justify-center items-center'>
                    <div className='bg-gray-800 text-gray-300 max-w-xl rounded-2xl overflow-hidden'>
                        ...
                        <div className='px-6 py-6 '>
                            ...
                            <button 
                            className='bg-indigo-500 px-5 py-2 rounded-lg mt-5 ml-auto block hover:bg-indigo-400'
                            onClick={() => setModal(false)}
                            > 
                                Cerrar
                            </button>
